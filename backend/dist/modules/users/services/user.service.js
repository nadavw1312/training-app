...
let UserService = class UserService {
    ...
    async create(dm) {
        ...
        const entity = user_transformer_1.UserTransformer.transformDmToEntity(dm);
        const newEntity = await this.repository.create(entity);
        return user_transformer_1.UserTransformer.transformEntityToDm(newEntity);
    }
    async findByEmail(email) {
        const entity = await this.repository.findByEmail(email);
        return entity ? user_transformer_1.UserTransformer.transformEntityToDm(entity) : null;
    }
    async findById(id) {
